...
function buildRegressionSteps(pythonExe) {
  ...
  return [
    ...
    nodeFile('RUNTIME-BUILD-02', '공통/실행 기준', '생성 중에는 새 빌드 창을 미룬다 (2026-09-06 사이즈컷 2장 유실)', 'tests/frontend/runtime_build_gate_waits_for_generation.test.cjs', 'fast'),
    nodeFile('STAGE-HONEST-01', '조립공장/이미지 단계', '끊긴 생성은 "N개 중 M개만" 으로 적고 완료라 하지 않는다', 'tests/frontend/interrupted_stage_is_reported_honestly.test.cjs', 'fast'),
    ...
    nodeFile('CAFE24-NONE-01', '1 제품/DB', 'Cafe24 후보 없음 확정 뒤 버튼이 곧바로 확정 상태로 바뀐다', 'tools/verify_cafe24_no_candidate_button_reflects_state_v1.cjs'),
